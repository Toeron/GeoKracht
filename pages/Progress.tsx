...
<<<<<<< HEAD
  const chartData = completedWorkouts.slice().reverse().map(w => ({
=======
...
<<<<<<< HEAD
        ...
        <BCard color="pink" className="p-2">
          ...
          <div className="text-2xl font-black">{chartData.length > 0 ? (totalVolume / chartData.length / 1000).toFixed(1) : 0}K</div>
      ...
      {loading && (
        <div className="text-center font-black uppercase py-8 animate-pulse text-gray-400">
          Loading Stats...
        </div>
=======
         <BCard color="lime" className="p-2">
